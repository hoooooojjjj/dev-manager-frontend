          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1">
                <span className="text-2xl font-bold text-green-600">{researchSummary.authoritativeSources}</span>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1">
                <span className="text-2xl font-bold text-blue-600">{researchSummary.jobPostings}</span>
        ...
        <TabsContent value="references" className="space-y-4">
          {references.map((ref) => (
            <Card key={ref.id} className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">{ref.summary}</p>
                <div className="flex items-center justify-between">
                  <div className="flex gap-2">
                    <Badge variant="secondary">
                      권위도: {ref.metadata.authority_score}/10
                    </Badge>
                    <Badge variant="secondary">
                      최신성: {ref.metadata.recency_score}/10
                    </Badge>
                  </div>
            ...
            <Card key={index} className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-medium mb-2">근거 소스</h4>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div>
                    <h4 className="text-sm font-medium mb-2">적용 영역</h4>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div>
                    <h4 className="text-sm font-medium mb-2">학습 포인트</h4>
